#Code Reference: https://github.com/allenai/allennlp/blob/main/allennlp/data/data_loaders/simple_data_loader.py
#Used here for ULF_reader tests only
...
@DataLoader.register("simpleloader_test", constructor="from_dataset_reader")
